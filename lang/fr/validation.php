...
return [
    ...
    */
    ...
    'email' => 'Le champ :attribute doit contenir une adresse e-mail valide (avec un @).',
    ...
    'image' => 'Le champ :attribute doit être une image (jpg, png, gif...).',
    ...
    'password' => [
        ...
        'uncompromised' => 'Le mot de passe saisi apparaît dans une fuite de données connue. Merci d\'en choisir un autre.',
    ],
    ...
    'required' => 'Ce champ est requis. Merci de le remplir.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Messages personnalisés par champ (surcharge un message ci-dessus
    | pour une combinaison précise attribut.regle)
    |--------------------------------------------------------------------------
    */
    ...
    'custom' => [
        'email' => [
            ...
            'email' => 'Il manque un « @ » : merci de saisir une adresse e-mail valide.',
        ],
        'password' => [
        ...
        'declaration_honneur' => [
            'accepted' => 'Vous devez cocher la déclaration sur l\'honneur pour continuer.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Noms des attributs (rend les messages naturels : "Le champ adresse
    | e-mail est requis." au lieu de "Le champ email est requis.")
    |--------------------------------------------------------------------------
    */
