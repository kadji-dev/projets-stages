<footer class="w-full bg-surface-container-lowest border-t border-outline-variant mt-auto">
    <div class="flex flex-col md:flex-row justify-between items-center py-8 px-6 md:px-12 max-w-7xl mx-auto gap-6">
        ...
        <div class="flex gap-6 text-xs text-on-surface-variant">
            ...
            <a href="#" class="hover:underline hover:text-primary">Conditions d'utilisation</a>
            <a href="#" class="hover:underline hover:text-primary">Support</a>
        </div>
        <div class="flex gap-3">
            <a href="#" class="w-9 h-9 rounded-full border border-outline-variant flex items-center justify-center text-on-surface-variant hover:bg-primary hover:text-white transition-all">
